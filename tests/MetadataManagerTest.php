...
class MetadataManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testEntitysAndPropertiesAndNavigationProperties()
    {
        ...
        $this->assertTrue($categoryType instanceof TEntityTypeType, get_class($categoryType));
        ...
        $this->assertTrue($customerDemographicType instanceof TEntityTypeType, get_class($customerDemographicType));
        ...
        $this->assertTrue($customerType instanceof TEntityTypeType, get_class($customerType));
        ...
        $this->assertTrue($employeeType instanceof TEntityTypeType, get_class($employeeType));
        ...
        $this->assertTrue($orderDetailType instanceof TEntityTypeType, get_class($orderDetailType));
        ...
        $this->assertTrue($orderType instanceof TEntityTypeType, get_class($orderType));
        ...
        $this->assertTrue($productType instanceof TEntityTypeType, get_class($productType));
